...
# -*- coding: utf-8 -*-
#
# ipylabel documentation build configuration file
#
...
_version_py = os.path.join(repo, "ipylabel", "_version.py")
version_ns = {}
...
latex_documents = [
    (master_doc, "ipylabel.tex", "ipylabel Documentation", "Danil Kireev", "manual"),
]
...
man_pages = [(master_doc, "ipylabel", "ipylabel Documentation", [author], 1)]
