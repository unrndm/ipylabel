...
data_files_spec = [
    ("share/jupyter/nbextensions/ipylabel", "ipylabel/nbextension", "**"),
    ("share/jupyter/labextensions/ipylabel", "ipylabel/labextension", "**"),
    ("share/jupyter/labextensions/ipylabel", ".", "install.json"),
    ("etc/jupyter/nbconfig/notebook.d", ".", "ipylabel.json"),
]
